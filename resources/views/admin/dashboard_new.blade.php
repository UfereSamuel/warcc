...
<div class="row mb-4">
    ...
    <div class="col-lg-6">
        <div class="chart-card">
            <div class="chart-header">
                <h3 class="chart-title">
                    <i class="fas fa-chart-doughnut mr-2"></i>Department Breakdown
                </h3>
            </div>
            <div class="chart-body">
...
new Chart(deptCtx, {
    type: 'pie',
    data: {
        labels: chartData.department_breakdown.map(item => item.department),
        datasets: [{
            data: chartData.department_breakdown.map(item => item.count),

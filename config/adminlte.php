...
return [
    ...
    */
    ...
    'title' => 'RCC Staff Management',
    'title_prefix' => '',
    'title_postfix' => ' - Africa CDC',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you can specify which authentication guard AdminLTE should use.
    |
    */
    ...
    */
    ...
    'logo_img_class' => 'brand-image elevation-2 bg-white rounded',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Africa CDC Logo',
    ...
    */
    ...
    'classes_body' => '',
    'classes_brand' => 'navbar-white navbar-light',
    'classes_brand_text' => '',
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'Weekly Trackers',
                    'route' => 'admin.reports.weekly-trackers',
                    'icon' => 'fas fa-fw fa-file-alt',
                ],
                [
        ...
        'AfricaCDC' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'css/admin-africa-cdc-theme.css',
                ],
            ],
        ],
        'AdminTextFixes' => [

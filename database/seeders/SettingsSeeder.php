    ...
    public function run(): void
    {
        $settings = [
            ...
            [
                ...
                'group' => 'general',
                'label' => 'Site Tagline',
                'description' => 'Short label shown next to the logo in the public navigation (keep concise — logo already shows Africa CDC)',
                'sort_order' => 2,
            ],
            [
            ...
            [
                'key' => 'contact_address',
                'value' => "Plot 114 Yakubu Gowon Cres, Asokoro\nAso 900103, Federal Capital Territory\nNigeria",
                'type' => 'textarea',
                'group' => 'contact',
                'label' => 'Physical Address',
                'description' => 'Complete physical address of your organization (editable anytime from Admin → Settings → Contact)',
                'sort_order' => 2,
            ],
            [
                'key' => 'contact_phone',
            ...
            [
                'key' => 'contact_email',
                'value' => 'westernrcc@africacdc.org',
                'type' => 'email',
                'group' => 'contact',
                'label' => 'Email Address',
            ...
            [
                ...
                'value' => 'https://maps.google.com/maps?q=Plot+114+Yakubu+Gowon+Cres,+Asokoro,+Abuja,+Nigeria&output=embed',
                'type' => 'url',
                'group' => 'contact',
                'label' => 'Google Maps Embed URL',
                'description' => 'Map shown on the Contact page (paste a Google Maps embed/share URL)',
                'sort_order' => 7,
            ],
            [
                'key' => 'contact_website',
                ...
                'type' => 'url',
                'group' => 'contact',
                'label' => 'Africa CDC Website URL',
                'description' => 'Official Africa CDC website linked from the public navigation, homepage, and footer',
                'sort_order' => 5,
            ],
            [
                'key' => 'contact_fax',
            ...
            // Homepage images (admin-updatable)
            [
                'key' => 'homepage_mission_image',
                'value' => '',
                'type' => 'image',
                'group' => 'homepage_images',
                'label' => 'Mission and Vision Image',
                'description' => 'Optional image shown beside the mission/vision section (recommended 1200x900px)',
                'sort_order' => 1,
            ],
            [
                'key' => 'homepage_gallery_1_image',
                'value' => '',
                'type' => 'image',
                'group' => 'homepage_images',
                'label' => 'Gallery Image 1',
                'description' => 'Homepage photo gallery image 1',
                'sort_order' => 2,
            ],
            [
                'key' => 'homepage_gallery_1_caption',
                'value' => '',
                'type' => 'text',
                'group' => 'homepage_images',
                'label' => 'Gallery Caption 1',
                'description' => 'Short caption for gallery image 1 (optional)',
                'sort_order' => 3,
            ],
            [
                'key' => 'homepage_gallery_2_image',
                'value' => '',
                'type' => 'image',
                'group' => 'homepage_images',
                'label' => 'Gallery Image 2',
                'description' => 'Homepage photo gallery image 2',
                'sort_order' => 4,
            ],
            [
                'key' => 'homepage_gallery_2_caption',
                'value' => '',
                'type' => 'text',
                'group' => 'homepage_images',
                'label' => 'Gallery Caption 2',
                'description' => 'Short caption for gallery image 2 (optional)',
                'sort_order' => 5,
            ],
            [
                'key' => 'homepage_gallery_3_image',
                'value' => '',
                'type' => 'image',
                'group' => 'homepage_images',
                'label' => 'Gallery Image 3',
                'description' => 'Homepage photo gallery image 3',
                'sort_order' => 6,
            ],
            [
                'key' => 'homepage_gallery_3_caption',
                'value' => '',
                'type' => 'text',
                'group' => 'homepage_images',
                'label' => 'Gallery Caption 3',
                'description' => 'Short caption for gallery image 3 (optional)',
                'sort_order' => 7,
            ],
        ];
